...
import { useChains, CubeSignerContext, useWallets } from "../hooks";
import { Chain, Wallet } from "../utils";
import { CubeSignerActionType, TransactionActionType } from "../lib";
import { Button, LargeButton } from "./Buttons";
    ...
    <Box display={"flex"} marginTop={"8px"}>
        ...
        <>
          <Box display={"block"} color={"#000C49"} width={"100%"}>
            ...
            <Link
              ...
              isExternal={true}
              href={provider?.getExplorerUrl(cubeSignerState.tx)}
            >
      ...
      {!cubeSignerState.error && !cubeSignerState.sending && !cubeSignerState.tx && wallet && (
        <SimpleGrid columns={2} gap={4}>
          <Box>
            <Text fontSize={"20px"} fontWeight={400} marginTop={0} marginBottom={"4px"}>
              From{" "}
            </Text>
            <WalletSelect
              wallets={wallets!}
          ...
          <Box>
            ...
            >
              <Box margin={"0 20px"} bg={"transparent"}>
                <wallet.asset.Icon />
              </Box>
              <Box margin={"0 20px"} bg={"transparent"}>
                {loadingBalance ? (
          ...
          <FormControl>
            ...
            <InputGroup>
              ...
              />
              <InputRightElement right={12} fontSize={"20px"} height={"76"} bg={"transparent"}>
                {wallet?.asset.Icon()}
              </InputRightElement>
            </InputGroup>
          </FormControl>
