...
import { loadManagementSession, login, logout } from "./setup";
...
describe("onRpcRequest", () => {
  ...
  beforeAll(async () => {
    ...
    bls = await org.createKey(BLS.Eth2Deposited);
    await role.addKeys([secp, bls, solana, btc], ["AllowRawBlobSigning"]);
