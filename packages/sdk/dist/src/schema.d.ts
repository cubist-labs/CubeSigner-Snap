...
export interface paths {
    ...
    "/v0/org/{org_id}/keys/get_keys": {
         ...
         * @deprecated
         * @description List Keys (Deprecated)
         *
         * Use `GET /v0/org/<org_id>/keys?<key_type>`
         */
    ...
    "/v0/org/{org_id}/roles": {
         ...
         *
         * Creates a new role in an organization. The request body is optional. Unless the logged-in user
    ...
    "/v0/org/{org_id}/roles/{role_id}/mfa/{mfa_id}": {
        /**
         ...
         */
        patch: operations["approveMfaRequest"];
    };
...
export interface components {
    schemas: {
        ...
        Eth1SignRequest: {
            /**
             * Format: int64
             * @description Chain id to set in the given transaction.
             */
            chain_id: number;
            /** @description `TypedTransaction` object as an untyped JSON value. */
            tx: Record<string, never>;
        };
        /**
         * @example {
        ...
        RequiredApproversStatus: {
            ...
            approved_by: components["schemas"]["StringSet"];
            /**
             * Format: int32
        ...
        Status: {
            RequiredApprovers: components["schemas"]["RequiredApproversStatus"];
        };
        StringSet: string[];
        TokenInfo: {
    ...
    btcSign: {
        parameters: {
            path: {
                ...
                org_id: string;
                /**
                 * @description bach32 encoding of the public key
